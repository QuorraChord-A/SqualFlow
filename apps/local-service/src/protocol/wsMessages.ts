...
const TimelineItemSchema = z.object({
  ...
  work_run_id: z.string().nullable(),
  presentation_turn_id: z.string().nullable(),
  message_kind: z.enum(["user", "assistant", "assistant-continuation", "running-guide", "work-run-terminal"]).nullable(),
  payload: z.unknown(),
  created_at: z.string(),
  updated_at: z.string(),
}).strict();
