...
it("Chat 图节点只显示锚定任务提示窗", async () => {
  render(<div style={{ width: 700, height: 300 }}><OrchestrationPlanGraph compact orchestrationNodes={orchestrationPlanFixture.nodes} /></div>);
...
it("待审批计划沿用原型的动画依赖连线与状态点", () => {
  const { container } = render(<div style={{ width: 700, height: 300 }}><OrchestrationPlanGraph compact orchestrationNodes={orchestrationPlanFixture.nodes} /></div>);
